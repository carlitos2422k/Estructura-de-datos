...
void mostrarMenuPrincipal() {
    ...
    std::cout << "2. Crear grafo pequeno" << std::endl;
...
void mostrarMenuRepresentacion() {
    std::cout << "1. Mostrar representacion logica" << std::endl;
        ...
        if (opcionPrincipal == 1 || opcionPrincipal == 2) {
            ...
            do {
                ...
                case 1:
                    ...
                    grafo.mostrarRepresentacionGrafica("Logica");
                    break;
                case 2:
                    grafo.representacionListaAdyacencia();
                    grafo.mostrarRepresentacionGrafica("Lista");
                    break;
                case 3:
                    grafo.representacionMatrizAdyacencia();
                    grafo.mostrarRepresentacionGrafica("Matriz");
                    break;
                case 4:
